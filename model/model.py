...
class DDPM(BaseModel):
    ...
    def test_registration(self):
        ...
        if isinstance(self.netG, nn.DataParallel):
            self.out_M, self.flow, self.contD, self.contF = self.netG.module.registration(input)
        else:
    ...
    def get_current_visuals_train(self):
        ...
        out_dict['flow'] = Metrics.tensor2im_(self.flow.detach().float().cpu(), min_max=min_max)
        return out_dict
