...
class GaussianDiffusion(nn.Module):
    ...
    def p_sample_loop(self, x_in):
        ...
        with torch.no_grad():
            ...
            x_recon = self.denoise_fn(torch.cat([x, x_f], dim=1), t)
            deform, flow = self.field_fn(torch.cat([x_m, x_recon], dim=1))
    ...
    def p_losses(self, x_in, noise=None):
        ...
        x_recon = self.denoise_fn(torch.cat([x_in['M'], x_in['F'], x_noisy], dim=1), t)   #denoise_fn为unet
